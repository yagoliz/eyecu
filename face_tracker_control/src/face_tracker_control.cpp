...
#include <face_tracker_control.h>
...
// Callback function
void FaceTracker::face_callback(const face_tracker_pkg::DistanceCamera::ConstPtr& msg) {
...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "face_tracker_control");
